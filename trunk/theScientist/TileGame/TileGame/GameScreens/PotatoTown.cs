...
namespace TileGame.GameScreens
{
    public class PotatoTown : PlayerScreen
    {
        ...
        protected override void LoadContent()
        {
            ...
            #region Story NPCs
            npcStoryAsterix = new NPC_Story_Asterix(Content.Load<Texture2D>("Sprite/Asterix2"), Content.Load<Script>("Scripts/AsterixDialog"), Content.Load<Texture2D>("CharacterPotraits/PortraitAsterix"), "Asterix");
            ...
            npcstory = new NPC_Story(Content.Load<Texture2D>("Sprite/NPCJohn"), null, Content.Load<Texture2D>("CharacterPotraits/John"), "John");
            npcstory.Origionoffset = new Vector2(25,65);
            ...
            npcstory = new NPC_Story_Fisherman(Content.Load<Texture2D>("Sprite/NPCFisherman2"), Content.Load<Script>("Scripts/FishmarketNoFish"), Content.Load<Texture2D>("CharacterPotraits/Fisherman"), "Fisherman");
