...
{
    public class TreeStandingBridge : Sprite
    {
         #region Field Region
        #endregion
        ...
        public TreeStandingBridge(Texture2D texture) : base(texture)
        {

        }

        public TreeStandingBridge(Texture2D texture, Vector2 position) :
            base(texture)
        {
