...
namespace TileEngine.Sprite.Projectiles
{
    public class SpinningAxe : AnimatedProjectile
    {
            ...
            : base(texture) 
        {
            ...
            FrameAnimation down = new FrameAnimation(2, 32, 32, 0, 0);
            down.FramesPerSeconds = 0.5f;
            this.Animations.Add("down", down);
                        
            FrameAnimation left = new FrameAnimation(2, 32, 32, 0, 0);
            left.FramesPerSeconds = 0.5f;
            this.Animations.Add("left", left);
                       
            FrameAnimation right = new FrameAnimation(2, 32, 32, 0, 0);
            right.FramesPerSeconds = 0.5f;
